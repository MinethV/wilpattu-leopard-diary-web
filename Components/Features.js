    ...
    const features = [
        {
            ...
            description: "Upload leopard photos and instantly identify Sri Lankan leopards using our AI-powered leopard identification system for Wilpattu National Park.",
            icon: (
